...
{
    public class ClientManagementEmployee : Employee
    {
        ...
        public ClientManagementEmployee(string empID, string name, string surname, string address, string phoneNum, string password)
        {
            this.empID = empID;
            this.name = name;
        ...
        {
            return obj is ClientManagementEmployee employee &&
